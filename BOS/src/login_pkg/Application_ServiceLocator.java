...
public class Application_ServiceLocator extends org.apache.axis.client.Service implements Application_Service {
    ...
    private java.lang.String Application_address = "http://127.0.0.1:1236/?wsdl";
    ...
    public Application_PortType getApplication() throws javax.xml.rpc.ServiceException {
    ...
    public Application_PortType getApplication(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_BindingStub _stub = new Application_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Application_BindingStub _stub = new Application_BindingStub(new java.net.URL(Application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("login", "Application");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("login", "Application"));
        }
