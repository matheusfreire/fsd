...
public class Application_ServiceLocator extends org.apache.axis.client.Service implements Application_Service {
    ...
    public description.Application_PortType getApplication() throws javax.xml.rpc.ServiceException {
    ...
    public description.Application_PortType getApplication(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            description.Application_BindingStub _stub = new description.Application_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (description.Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                description.Application_BindingStub _stub = new description.Application_BindingStub(new java.net.URL(Application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("description", "Application");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("description", "Application"));
        }
